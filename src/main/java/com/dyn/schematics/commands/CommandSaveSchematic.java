...
public class CommandSaveSchematic extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		try {
			DataOutputStream dataoutputstream = new DataOutputStream(new FileOutputStream(new File(Minecraft.getMinecraft().mcDataDir, "schematics/" + name)));
	...
	public byte[][] getBlockBytes(World world, int width, int height, int length, BlockPos bottom, NBTTagList tileEntities) {
